...
var magix = function (fileData, mediaKeyBase64, mediaType, expectedSize, mimetype) {
    ...
    var info = "WhatsApp " + (exports.mediaTypes[mediaType.toUpperCase()] || exports.mediaTypes[Object.keys(exports.mediaTypes).filter(function (type) { return mimetype.includes(type.toLowerCase()); })[0]]) + " Keys";
    var hash = 'sha256';
