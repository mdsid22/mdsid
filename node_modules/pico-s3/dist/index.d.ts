...
import { S3RequestOptions, S3UploadOptions, S3GetOptions } from './client';
export * from './client';
/**
...
export declare class PicoS3 {
    ...
    upload(options: S3UploadOptions): Promise<string>;
    getObject(options: S3GetOptions): Promise<import("axios").AxiosResponse<any>>;
