...
const start = async (urbae = new urbae()) => {
    ...
    console.log(color(figlet.textSync('MDSID BOT', { font: 'Ghost', horizontalLayout: 'default' })))
    console.log(color('------------------------------------------------------------------------', 'white'))
    console.log(color('[CREATOR]', 'aqua'), color('Mas Cakra P.R', 'magenta'))
    console.log(color('[BOT]', 'aqua'), color('MDSID BOT is Active!', 'magenta'))
    console.log(color('[VER]', 'aqua'), color('0.1.0', 'magenta'))
